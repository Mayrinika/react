        ...
        return (
            <div className="root">
                <div className="form">
                    ...
                    <div>
                        <span>&#8381;</span>
                        <Money value={this.state.valueInRubles.toString()} onChange={this.handleChangeRubles}/>
                        &mdash;
                        <Money value={this.state.valueInEuros.toString()} onChange={this.handleChangeEuros}/>
                        <span>&euro;</span>
                    </div>
                </div>
            </div>
